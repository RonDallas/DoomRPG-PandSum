...
Class PyrobruiserCometDRPGFix :
PyrobruiserComet replaces PyrobruiserComet 										//Fix for Pyrobruiser Comet with DRLA i think
{
    States
    {
Spawn:
...
Class OverchargedPlasmaBallTrailRPG :
OverchargedPlasmaBallTrail replaces OverchargedPlasmaBallTrail
{
    States
    {
Spawn:
...
Class WidowBigShotRPG :
WidowBigShot replaces WidowBigShot
{
    States
    {
Spawn:
...
Class FusionArachnotronRPG :
FusionArachnotron replaces FusionArachnotron
{
    Default
    {
        DropItem "DRPGCellSpawner", 128;
...
Class TankubusSpawner :
RandomSpawner replaces Tankubus
{
    Default
    {
...
Class PandPursuerBossSpawnerRPG :
PandPursuerBossSpawner replaces PandPursuerBossSpawner
{
    States
    {
Spawn:
...
SpawnRoasterockLoop:
        SPKR A 1 Bright Light("RBFGBALL")
        {
            ...
            for(user_fx = 0; user_fx<=2; user_fx++)
            {
                ...
                if(user_pcolor == 1)
                {
                    A_SpawnParticle("FF4949",SPF_FULLBRIGHT|SPF_RELATIVE,25,frandom(15,16),random(0,360),frandom(0,20),0,frandom(0,4),0,0,frandom(2,3),0,0,0,1,-1,-1);
                }
                else if(user_pcolor == 2)
                {
                    A_SpawnParticle("FF2424",SPF_FULLBRIGHT|SPF_RELATIVE,25,frandom(15,16),random(0,360),frandom(0,20),0,frandom(0,4),0,0,frandom(2,3),0,0,0,1,-1,-1);
                }
                else if(user_pcolor == 3)
                {
                    A_SpawnParticle("FF6D6D",SPF_FULLBRIGHT|SPF_RELATIVE,25,frandom(15,16),random(0,360),frandom(0,20),0,frandom(0,4),0,0,frandom(2,3),0,0,0,1,-1,-1);
                }
                else if(user_pcolor == 4)
                {
                    A_SpawnParticle("FF0000",SPF_FULLBRIGHT|SPF_RELATIVE,25,frandom(15,16),random(0,360),frandom(0,20),0,frandom(0,4),0,0,frandom(2,3),0,0,0,1,-1,-1);
                }
            }
            effectloop++;
        }
...
Class MyrkuraSpawnerRPG :
MyrkuraSpawner replaces MyrkuraSpawner
{
    States
    {
Spawn:
